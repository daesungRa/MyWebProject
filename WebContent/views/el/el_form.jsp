...
<head>
<meta charset="UTF-8">
<title>EL Insert Form</title>
</head>
<body>

	<div id='elForm'>
		<h1>EL Insert Form</h1>
		
		<form name='frm' action='index.jsp?aside=./index_el.jsp&content=./views/el/el_form_result.jsp' method='post'>
			<label>인사말 : </label>
			<input type='text' name='intro' placeholder='임의의 값을 입력하세요' /><br/>
			
			<label>좋아하는 스포츠 : </label>
			<label><input type='radio' name='sports' value='baseball' checked />야구</label>
